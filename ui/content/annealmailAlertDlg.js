...
/* global EnigInitCommon: false, AnnealMailEvents: false, EnigGetString: false, EnigGetOS: false */
...
EnigInitCommon("annealmailAlertDlg");

function onLoad() {
  var dlg = document.getElementById("annealmailAlertDlg");
...
function centerDialog() {
  if (EnigGetOS() != "Darwin")
    document.getElementById("annealmailAlertDlg").centerWindowOnScreen();
}
