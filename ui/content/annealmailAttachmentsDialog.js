/*global EnigInitCommon EnigGetString AnnealMailLog */
/*
...
EnigInitCommon("annealmailAttachmentsDialog");
...
function annealmailAttachDlgLoad() {
  AnnealMailLog.DEBUG("annealmailAttachmentsDialog.js: Load\n");

  var dialog = document.getElementById("attachmentsDialog");
  dialog.setAttribute("title", EnigGetString("enigPrompt"));

  var optionSel = document.getElementById("annealmailAttachOptions");
  ...
  if (gArguments[ENIG_INPUT].restrictedScenario) {
    document.getElementById("annealmailAttachSkipDlg").disabled = true;
  }
}


function annealmailAttachDlgAccept() {
  AnnealMailLog.DEBUG("annealmailAttachDlgAccept.js: Accept\n");

  var optionSel = document.getElementById("annealmailAttachOptions");
  var skipDlg = document.getElementById("annealmailAttachSkipDlg");
