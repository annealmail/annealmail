...
EnigInitCommon("annealmailAdvancedIdentityDlg");
...
function enigEnableUrlName() {
  if (gOpenPgpHeaderUrl.checked) {
    document.getElementById("annealmail_bcUseUrl").removeAttribute("disabled");
  }
  else {
    document.getElementById("annealmail_bcUseUrl").setAttribute("disabled", "true");
  }
}
