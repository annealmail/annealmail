...
/*global TestHelper: false, withEnvironment: false, withAnnealMail: false, component: false,
  withTestCcrHome: false, osUtils: false, unescape: false */

testing("system.jsm"); /*global AnnealMailSystem: false, Cc: false, Ci: false */
...
function testEncoding(charset, from, to) {
  from = unescape(from);
  to = unescape(to);
  let result = AnnealMailSystem.convertNativeToUnicode(from, charset);
...
test(function shouldTestUnixCharsetConversion() {
  ...
  let cs = AnnealMailSystem.determineSystemCharset();
